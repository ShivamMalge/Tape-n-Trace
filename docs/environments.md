...
**Package under test:** `vyakarana 0.1.0rc2`, the wheel built by
...
[`v0.1.0rc2`](https://github.com/ShivamMalge/Tape-n-Trace/releases/tag/v0.1.0rc2) (rc2 created 2026-08-31 after the author's Colab run of rc1 showed the
...
| JupyterLab 4+ | 2026-08-24 (V1) | dev install, 0.0.x bridge | ☑ rendering verified by the author at V1; **re-check with the 0.1.0rc2 wheel pending** | run `vyakarana/notebooks/quickstart.ipynb` in JupyterLab from a venv with the wheel installed; record the JupyterLab version here |
...
python -m build --wheel vyakarana           # dist/vyakarana-0.1.0rc2-py3-none-any.whl
