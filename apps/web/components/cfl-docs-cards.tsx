...
export function NonClosureCard(): React.JSX.Element {
  return (
    <section aria-label="Not closed under intersection" className="tnt-card tnt-stack-sm" style={{ borderLeft: '3px solid var(--tnt-dead)' }}>
      <strong>Not closed under intersection — Example 7.26</strong>
      <div className="tnt-panels tnt-panels-narrow">
        {[CFL_INTERSECTION_DEMO.l1, CFL_INTERSECTION_DEMO.l2].map((side) => (
          <div key={side.title}>
            ...
            <div className="tnt-meta tnt-mono" style={{ marginTop: 'var(--tnt-space-1)' }}>
...
export function UndecidableCard(): React.JSX.Element {
  return (
    <section aria-label="What cannot be decided" className="tnt-card tnt-stack-sm">
      <strong>Questions no page of this tool decides</strong>
      <p style={{ margin: 0 }}>
      ...
      <ul className="tnt-stack-sm" style={{ margin: 0, paddingLeft: 'var(--tnt-space-5)' }}>
