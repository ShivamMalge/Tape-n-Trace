...
export default function UnixRegexPage(): React.JSX.Element {
  return (
    <div className="tnt-page" style={{ maxWidth: 860 }}>
      <h1 style={{ fontSize: 26 }}>UNIX regular expressions</h1>
      ...
      <section style={{ marginTop: 28 }}>
        <h2 style={{ fontSize: 19 }}>Does this feature keep the language regular?</h2>
        <p className="tnt-muted" style={{ marginTop: 0, maxWidth: '64ch' }}>
      ...
      <section style={{ marginTop: 32 }}>
        <h2 style={{ fontSize: 19 }}>Lexical analysis</h2>
        <p style={{ maxWidth: '64ch' }}>
      ...
      <section style={{ marginTop: 32 }}>
        <h2 style={{ fontSize: 19 }}>Where this shows up in the exam</h2>
        <p style={{ maxWidth: '64ch' }}>
