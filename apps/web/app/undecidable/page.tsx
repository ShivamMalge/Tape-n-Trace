  ...
  return (
    <div className="tnt-page">
      ...
      <section className="tnt-section">
        <h2>Where the languages live — Fig. 9.2</h2>
        <p className="tnt-prose tnt-sm">
        ...
        />
        <p className="tnt-prose tnt-sm" style={{ marginTop: 'var(--tnt-space-3)' }}>
          <a href="/hierarchy">See the whole hierarchy →</a>
        </p>
      </section>

      <section className="tnt-section">
        <h2>A language and its complement — §9.2.2</h2>
        <p className="tnt-prose tnt-sm">
      ...
      <section className="tnt-section">
        <h2>What the two classes are closed under</h2>
        <p className="tnt-prose tnt-sm">
      ...
      <section className="tnt-section">
        ...
        <ul className="tnt-prose tnt-sm tnt-stack-sm" style={{ paddingLeft: 20 }}>
          <li>
